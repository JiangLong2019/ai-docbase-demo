# EDS FAQ Block - Terri Scheer Structure

A responsive FAQ (Frequently Asked Questions) block component that exactly matches the [Terri Scheer FAQ page](https://www.terrischeer.com.au/faqs) design and functionality, including the same HTML structure and hide/show behavior.

## Features

- **Exact Terri Scheer Design**: Matches the visual design and layout of the Terri Scheer FAQ page
- **Category Filtering**: Filter FAQ items by categories with pill-shaped buttons
- **Hide/Show Functionality**: FAQ items can be hidden/shown with smooth animations
...
The FAQ block uses the exact same structure as Terri Scheer's FAQ page:
...
The FAQ block implements the exact same hide/show behavior as Terri Scheer:

- **Click to Expand**: Click on any question to show the answer
- **Click to Collapse**: Click again to hide the answer
- **Auto-Close**: Only one answer can be open at a time
- **Smooth Animations**: Professional transitions for show/hide actions
- **Visual Indicators**: Plus (+) and minus (−) icons show state

## Design Features

### Terri Scheer Matching Elements
...
- **Professional color scheme** matching Terri Scheer
...
See `faq-demo.html` for a complete working example with the exact same FAQ content as the Terri Scheer page.
