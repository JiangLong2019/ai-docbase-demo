...
A responsive FAQ (Frequently Asked Questions) block component with category filtering and expandable answers, designed to match the [Terri Scheer FAQ page](https://www.terrischeer.com.au/faqs) design and functionality.
...
- **Modern UI**: Clean, professional design matching Terri Scheer's aesthetic
